...
int main(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC | RCC_APB2Periph_GPIOA, ENABLE); //pod³¹czenie zagara
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_AFIO, ENABLE); //modu³ funkcji alternatywnych
	...
	gpio.GPIO_Mode = GPIO_Mode_Out_PP; //wyjœcie push-pull
